  ...
  return (
    <div className="bg-white-50 flex w-full h-screen font-poppins">
      <div className="flex flex-col items-center w-full">
        <h1 className="text-4xl text-purple-400 font-semibold my-20">
          Hi!{" "}
        ...
        <div className="flex bg-white w-[900px] rounded-2xl h-96 p-10 gap-4">
          ...
          <div className="flex flex-col w-full h-full bg-white-50 rounded-2xl px-8 justify-center gap-4">
            <h1 className="text-purple-400 text-2xl font-semibold">
              Send us a message
            </h1>
            ...
            <span className="text-purple-400">
              Email us: <span className='text-purple-100'>todolist@gmail.com</span>
            </span>
          </div>
        </div>
      </div>
