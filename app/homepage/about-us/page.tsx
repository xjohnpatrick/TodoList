...
export default function AboutUs() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-[1500px] lg:h-[1000px] bg-white-50 font-poppins gap-4">
      <div className="flex flex-col w-64 lg:w-[800px] items-center text-center gap-4">
        ...
        {teamMembers.map((item, index) => (
          ...
          >
            <div className="flex flex-col w-full h-full items-center justify-center">
              ...
              <span className="text-xs sm:text-sm text-gray-50/80">{item.textLink}</span>
            </div>
